export const Copy = {
  ...
  onboarding: {
    pageOneTitle: "Stay on track",
    pageOneSubtitle: "From hormones to vitamins, Orbia keeps your daily routine in perfect flow",
    reminderCard1Title: "Day 14: Take Progestogen",
    reminderCard1Detail: "200mg Day 14 of day 28 at 9pm",
    reminderCard2Title: "Oestrogen Gel",
    reminderCard2Detail: "2 pumps Daily at 8am",
    reminderCard3Title: "Change patch",
    reminderCard3Detail: "Every Monday & Thursday at 8am",
    reminderCard4Title: "Take Multi Vitamin",
    reminderCard4Detail: "Daily at 8am",
    reminderCard5Title: "Antibiotics",
    reminderCard5Detail: "Daily at 8am, 1pm, 5pm & 9pm",
    takeButton: "TAKE",
    now: "now",
    pageTwoTitle: "Hello,",
  ...
  more: {
    ...
    rateAppSubtitle: "Share the love",
    shareTitle: "Share with a friend",
    shareSubtitle: "Help grow our community",
    shareMessage: "I've been using Orbia to manage my hormone-related reminders. Check it out!",
    aboutTitle: "About",
    aboutSubtitle: "See where we are heading",
  ...
  subscription: {
    ...
    proCardTitle: "Orbia Pro",
    proCardSubtitle: "THE CYCLE ENGINE",
    proCardTagline: "Keeping Orbia ad-free and supporting independent development",
    supporterCardTitle: "Orbia Supporter",
    supporterCardSubtitle: "BACK THE MISSION",
    supporterCardBody: "Your support directly funds new features and keeps the app independent.",
    supporterCardLink: "See where we're headed",
    yearlyPeriod: "Yearly",
    monthlyPeriod: "Monthly",
    yearlySubLine: "12 Months @",
    ...
    unlockProCta: (monthlyPrice?: string | null) =>
      monthlyPrice ? `UPGRADE FOR ${monthlyPrice} A MONTH` : "UPGRADE NOW",
    trialEndedTitle: "Unlock the cycle engine",
    trialEndedBody: "Your trial has ended. Subscribe to continue cycle reminders.",
    trialEndedLink: (monthlyPrice?: string | null) =>
      monthlyPrice ? `Upgrade for ${monthlyPrice} a month` : "Upgrade now",
    ...
    trialNotifDay1Title: "Your trial ends tomorrow",
    trialNotifDay0Title: "Your Orbia trial has ended",
    trialNotifBody: "Upgrade now to continue receiving cycle reminders",
